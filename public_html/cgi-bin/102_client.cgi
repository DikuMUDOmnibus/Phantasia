...
print "<CENTER><IMG SRC=\"/graphics/102_client.jpeg\" ALT=\"\" WIDTH=\"224\" HEIGHT=\"17\"></CENTER>";

print "<CENTER><P>The Java 1.02 client is now loading and should appear in a moment";

print "<APPLET CODE=\"pClient.class\" CODEBASE=\"/102_client\" HEIGHT=0 WIDTH=0><PARAM name=\"num\" value=\"$cookie{'num'}\"><PARAM name=\"hash\" value=\"$cookie{'hash'}\"><PARAM name=\"time\" value=\"$ENV{'QUERY_STRING'}\">";
